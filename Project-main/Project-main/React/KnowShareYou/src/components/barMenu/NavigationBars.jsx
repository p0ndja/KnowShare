...
function NavigationBars(props) {
    ...
    return (
        <div>
            {
                profile != null ? <NavigationBarLogout pg={props.pg} /> :

                    <header className="p-3 text-center">
                        <div className="container">
                            <div className="d-flex flex-wrap align-items-center justify-content-center shadow bar m-2 pt-2 ">
                                <a
                                    href="/"
                              ...
                              {filteredItems.length > 0 ? (
                                ...
                                <a href='/login'>
                                    <button className="button-18 my-2" role="button">
                                        เข้าสู่ระบบ
                                    </button>
                                </a>
                            </div>
