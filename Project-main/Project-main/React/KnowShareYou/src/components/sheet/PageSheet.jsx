...
function PageSheet() {
    ...
    const dataCalculus = [
        ...
        { id: 5, name: 'นาย ธนพล พรหมสุข', pathImg: 'https://s3-ap-southeast-1.amazonaws.com/tv-prod/photo/150129-large.png', title: 'แบบฝึกหัด 4', describe: 'แบบฝึกหัด 3 ข้อ 1 ข้อ 2 ข้อ 3 ข้อ 4 ข้อ 5 ข้อ 6 ข้อ 7 ข้อ 8 ข้อ 9 ข้อ 10' },
        { id: 6, name: 'นาย ธนพล พรหมสุข', pathImg: 'https://cdn1.byjus.com/wp-content/uploads/2019/03/differential-calculus-700x430.png', title: 'แบบฝึกหัด 5', describe: 'แบบฝึกหัด 2 ข้อ 1 ข้อ 2 ข้อ 3 ข้อ 4 ข้อ 5 ข้อ 6 ข้อ 7 ข้อ 8 ข้อ 9 ข้อ 10' }
        ,{ id: 7, name: 'นาย ธนพล พรหมสุข', pathImg: '../../public/filepdf/pdf1.pdf', title: 'แบบฝึกหัด 6', describe: 'แบบฝึกหัด 1 ข้อ 1 ข้อ 2 ข้อ 3 ข้อ 4 ข้อ 5 ข้อ 6 ข้อ 7 ข้อ 8 ข้อ 9 ข้อ 10' },
    ]
        ...
        <div className='container'>
            ...
            <div className="sheet_subject w-100">
                ...
                <div className="sheet_title d-flex justify-content-center flex-column align-items-center pt-4">
                    ...
                    <img src="../../public/icon-temprade.svg" alt="" className=' img-fluid ' />
                </div>
