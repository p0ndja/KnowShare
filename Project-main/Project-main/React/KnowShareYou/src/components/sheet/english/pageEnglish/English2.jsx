...
function English2() {
    ...
    const nameSubjectTH = "ภาษาอังกฤษ II";
    const nameSubject = "ค้นหา ชีทสรุปของ" + nameSubjectTH;
    const dataCalculus = [
        { id: 1, name: 'นายปิยังกูร สารภาค ', pathImg: 'https://cdn.discordapp.com/attachments/1093665791016177674/1093677632735952926/image.png', title: 'Eng_2 1', describe: 'แบบฝึกหัด 1 ข้อ 2 ข้อ 3 ข้อ 4 ข้อ 5 ข้อ 6 ' }
    ]
